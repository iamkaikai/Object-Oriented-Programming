...
public class DotTreeGUI extends DrawingGUI {
	...
	private static final Color[] rainbow = {Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.BLUE, Color.PINK};
	...
	public void handleMousePress(int x, int y) {
		if (mode == 'a') {
			...
			// TODO: YOUR CODE HERE
			System.out.println("press in Q mode...");
	...
	public void drawTree(Graphics g, PointQuadtree<Dot> tree, int level) {
		...
		g.fillRect(x, y1, 1, h);		//vertical line
		g.fillRect(x1, y, w,1);		//horizontal line
