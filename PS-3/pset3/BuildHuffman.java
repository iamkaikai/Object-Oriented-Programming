...
public class BuildHuffman implements Huffman{
    ...
    public static void main(String[] args) throws Exception{
        ...
        String path = "./inputs/USConstitution.txt";
        String compressedPath = "./inputs/USConstitution_compressed.txt";
        String decompressedPath = "./inputs/USConstitution_decompressed.txt";
