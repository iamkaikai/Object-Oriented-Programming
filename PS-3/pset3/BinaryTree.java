...
/**
 * @Author: Christopher Kang and Kyle Huang
 */
...
//	public BinaryTree<E> copyToDepth(int d){		//1
//		int cur_depth = d - height();				//1-1=0
//
//
//		if(cur_depth <= d){
//
//			if(cur_depth == 0) {
//				BinaryTree<E> new_tree = new BinaryTree<E>(data);
//			}
//			if (hasLeft()){
//				left.copyToDepth(cur_depth);
//				cur_depth = depth - left.height();
//			}
//			if (hasRight()){
//				right.copyToDepth(cur_depth);
//				cur_depth = depth - right.height();
//			}
//		}
//
//		return new_tree;
//	}
	...
	public BinaryTree<E> copyToDepth(int d) {
		...
		BinaryTree<E> temp_left = null;
		BinaryTree<E> temp_right = null;
		if (hasLeft()) temp_left = left.copyToDepth(d-1);
		if (hasRight()) temp_right = right.copyToDepth(d-1);
		return new BinaryTree<E>(data, temp_left, temp_right);
	}
